...
if SOURCE != s:
    print("So sad, you have changed source, change it back to ` https://github.com/mahtoanjali/Anjali-Chatgpt-bot `  else I won't work")
    sys.exit(1)  
...
if __name__ == "__main__":
    ...
    print(f"""JOIN  @AnjalixSupportxGroup
